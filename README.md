...
Description
-----------
This module implements the components necessary to support the
[SMART App Launch Framework](http://hl7.org/fhir/smart-app-launch/index.html) inside OpenMRS with the
[FHIR2 module](https://github.com/openmrs/openmrs-module-fhir2). It defaults to using [Keycloak](https://www.keycloak.org/)
as the authorization server, where the authorization server is expected to be running the OpenMRS Authentication for Keycloak
component.
